sap.ui.define([
		...
		return BaseObject.extend("zwx.sm.itsm.myincidents.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zwx.sm.itsm.myincidents.model.ListSelector
			 */
			 ...
			 * @return {zwx.sm.itsm.myincidents.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
